...
def run_maniskill2_eval_single_episode(
    ...
    video_name = video_name + f"_{'_'.join(task_description.split())}"
    ...
    video_path = os.path.join(logging_dir, f"{scene_name}/{control_mode}/{env_save_name}/rob_{robot_init_x}_{robot_init_y}_rot_{r:.3f}_{p:.3f}_{y:.3f}_rgb_overlay_{rgb_overlay_path_str}/{video_name}")
