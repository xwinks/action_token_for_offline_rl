...
import yaml
from action_prediction.src.models.motogpt import MotoGPT
from action_prediction.src.trainers.latent_motion_prediction_trainer import LatentMotionPredictionTrainer

def main(cfg):
    # Prepare rgb_processor
    rgb_preprocessor = get_rgb_preprocessor(**cfg['rgb_preprocessor_config'])

    motion_prediction_transformer_config_path = cfg['motion_prediction_transformer_config_path']
    print(f"initializing motion prediction transformer from {motion_prediction_transformer_config_path} ...")
    motion_prediction_transformer_config = omegaconf.OmegaConf.load(motion_prediction_transformer_config_path)
    motion_prediction_transformer = hydra.utils.instantiate(motion_prediction_transformer_config)
    motion_prediction_transformer.config = motion_prediction_transformer_config     

    print("the motion prediction transformer is: ", motion_prediction_transformer)
    ...
    trainer = LatentMotionPredictionTrainer(
        motion_prediction_transformer=motion_prediction_transformer,
