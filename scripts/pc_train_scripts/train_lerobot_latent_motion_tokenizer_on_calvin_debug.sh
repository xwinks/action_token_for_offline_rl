...
accelerate launch --main_process_port 29501 lerobot_train_latent_motion_tokenizer.py --config_path "${PROJECT_ROOT}/latent_motion_tokenizer/configs/train/${CONFIG_NAME}.yaml"
